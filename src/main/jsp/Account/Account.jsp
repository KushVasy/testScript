...
<script src="<spring:eval expression="@environment.getProperty('mycdn') "/>src/main/js/uncommon.js?v=0.0.10"></script>
<html>
...
<form name="localeForm" action="index.jsp1" method="post">
